...
class UploadAction extends Action {
    ...
    function uploadFile()
    {
        ...
        $type = $this->_get('type');
        //文件保存目录路径
        $save_path = $php_path . 'Public/';
        //文件保存目录URL
        $save_url = $php_url . 'Public/';
        //定义允许上传的文件扩展名
        $ext_arr = array(
        ...
        else $dir_name = 'Upload/'.$dir_name;
        import('ORG.Net.UploadFile');
        $upload = new UploadFile();// 实例化上传类
        $upload->maxSize  = 3145728 ;// 设置附件上传大小
        $upload->allowExts  = array('jpg', 'gif', 'png', 'jpeg');// 设置附件上传类型
        $upload->savePath =  './Public/'.$dir_name.'/';// 设置附件上传目录
...
//            [savename] => 566a8f4746a41.gif
//            [hash] => ef9894903ca2724a6766f68abf51f443
//        )
